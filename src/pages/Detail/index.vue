          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              >
                ...
                <dd
                  changepirce="0"
                  :class="{ active: spuSaleAttrValueList.isChecked == 1 }"
                  v-for="(
                    spuSaleAttrValueList, index
                  ) in spuSaleAttr.spuSaleAttrValueList"
                  :key="spuSaleAttrValueList.id"
                  @click="changeActive(spuSaleAttrValueList,spuSaleAttr.spuSaleAttrValueList)"
                >
