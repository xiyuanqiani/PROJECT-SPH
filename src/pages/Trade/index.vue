<template>
  <div class="trade-container">
    ...
    <div class="sub clearFix">
      <a class="subBtn"  @click="submitTrade"
        >提交订单</a
      >
    </div>
  </div>
...
export default {
  ...
  computed: {
    ...
    ...mapState({ orderInfo: (state) => state.Trade.order }),
    // 默认用户信息
    userDefault() {
